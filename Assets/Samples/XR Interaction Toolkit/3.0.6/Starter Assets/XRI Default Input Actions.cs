...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""TriggerBoth"",
            ""id"": ""74bb5470-6a65-45f3-bacf-e13686c9217b"",
            ""actions"": [
                {
                    ""name"": ""LeftTrigger"",
                    ""type"": ""Button"",
                    ""id"": ""fbc34e9a-988a-4e0f-8255-0facb59b426f"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""RightTrigger"",
                    ""type"": ""Button"",
                    ""id"": ""18c060ec-2324-43cf-9486-e94e900c4251"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""66012629-e196-4782-80bc-b707d9c91e2b"",
                ...
                {
                    ""name"": """",
                    ""id"": ""5863f030-0521-492e-8c0d-54ad88632bd8"",
    ...
    ""controlSchemes"": []
        ...
        // TriggerBoth
        m_TriggerBoth = asset.FindActionMap("TriggerBoth", throwIfNotFound: true);
        m_TriggerBoth_LeftTrigger = m_TriggerBoth.FindAction("LeftTrigger", throwIfNotFound: true);
        m_TriggerBoth_RightTrigger = m_TriggerBoth.FindAction("RightTrigger", throwIfNotFound: true);
    }
    ...
    ~@XRIDefaultInputActions()
    {
        ...
        UnityEngine.Debug.Assert(!m_TriggerBoth.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.TriggerBoth.Disable() has not been called.");
    }
    ...
    // TriggerBoth
    private readonly InputActionMap m_TriggerBoth;
    private List<ITriggerBothActions> m_TriggerBothActionsCallbackInterfaces = new List<ITriggerBothActions>();
    private readonly InputAction m_TriggerBoth_LeftTrigger;
    private readonly InputAction m_TriggerBoth_RightTrigger;
    public struct TriggerBothActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public TriggerBothActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @LeftTrigger => m_Wrapper.m_TriggerBoth_LeftTrigger;
        public InputAction @RightTrigger => m_Wrapper.m_TriggerBoth_RightTrigger;
        public InputActionMap Get() { return m_Wrapper.m_TriggerBoth; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(TriggerBothActions set) { return set.Get(); }
        public void AddCallbacks(ITriggerBothActions instance)
        {
            if (instance == null || m_Wrapper.m_TriggerBothActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_TriggerBothActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(ITriggerBothActions instance)
        {
            @LeftTrigger.started -= instance.OnLeftTrigger;
            @LeftTrigger.performed -= instance.OnLeftTrigger;
            @LeftTrigger.canceled -= instance.OnLeftTrigger;
        ...
        public void RemoveCallbacks(ITriggerBothActions instance)
        {
            if (m_Wrapper.m_TriggerBothActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ITriggerBothActions instance)
        {
            foreach (var item in m_Wrapper.m_TriggerBothActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_TriggerBothActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    public TriggerBothActions @TriggerBoth => new TriggerBothActions(this);
    ...
    public interface ITriggerBothActions
    {
